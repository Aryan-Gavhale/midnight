...
<section className="h-[700px] relative py-32 md:py-48 bg-gradient-to-r from-black to-gray-900 text-white transition-all duration-1000 ease-in-out">
{/* Your content goes here */}
  {/* Your content here */}



      <div className="absolute container mx-auto px-8 flex flex-col md:flex-row items-center justify-between bottom-4">
        {/* Image Section */}
        <motion.div
        ...
        >
          <img
            src={realestate} // Replace with your image URL
            alt="Real Estate"
        ...
        >
          ...
          <motion.button
            ...
            >
              <Link to="/realestate">Explore</Link>
            </motion.button>
        </motion.div>
      </div>
    </section>
