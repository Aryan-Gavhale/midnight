...
const Finance = () => {
  ...
  return (
    <section className="h-[700px] relative -mt-36 py-32 md:py-48 bg-gradient-to-r from-black to-gray-900 text-white transition-all duration-1000 ease-in-out mb-20">
      <div className="absolute container mx-auto px-8 flex flex-col md:flex-row items-center justify-between top-[100px]">
        {/* Description Section */}
        <motion.div
        ...
        >
          <img
            src={fin} // Replace with your IT solutions image URL
            alt="IT Solutions"
